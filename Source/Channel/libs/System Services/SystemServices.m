...
//                                                                 @"ProcessesInformation",
                                                                 @"DiskSpace",
                                                                 @"FreeDiskSpaceNotFormatted",
                                                                 @"FreeDiskSpaceFormatted",
                                                                 @"UsedDiskSpaceNotFormatted",
                                                                 @"UsedDiskSpaceFormatted",
                                                                 @"LongDiskSpace",
                                                                 @"LongFreeDiskSpace",
                                                                 @"TotalMemory",
                                                                 @"FreeMemoryNotFormatted",
                                                                 @"FreeMemoryFormatted",
                                                                 @"UsedMemoryNotFormatted",
                                                                 @"UsedMemoryFormatted",
                                                                 @"ActiveMemoryNotFormatted",
                                                                 @"ActiveMemoryFormatted",
                                                                 @"InactiveMemoryNotFormatted",
                                                                 @"InactiveMemoryFormatted",
                                                                 @"WiredMemoryNotFormatted",
                                                                 @"WiredMemoryFormatted",
                                                                 @"PurgableMemoryNotFormatted",
                                                                 @"PurgableMemoryFormatted",
                                                                 @"DeviceOrientation",
                                                                 @"Country",
                                                                 @"Language",
                                                                 @"TimeZone",
